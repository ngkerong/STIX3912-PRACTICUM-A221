    ...
    <body>
        ...
        <div class="w3-container w3-padding-64 form-container-reg">
            <div class = "w3-card">
                ...
                <form class = "w3-container w3-padding" name="updatePassForm" action = "updatestaffpass.php" method = "post" onsubmit = "return confirmDialog4()" enctype = "multipart/form-data">
                    
                    <p hidden>
                        <input class="w3-input w3-border w3-round" name = "icno" id = "idicno" type = "text" value = "<?php echo $icno; ?>">
                    </p>
