<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $status = $_POST["status"];
        $sqlupdatestaff = "UPDATE tbl_staff SET name = '$name' , pemail = '$pemail' , cemail = '$cemail' , phone = '$phone' , depart = '$depart' , type = '$type' , address = '$address', status = '$status' WHERE icno = '$icno'";
        ...
        <div class="w3-container w3-padding-64 form-container-reg">
            <div class = "w3-card">
                <div class = "w3-container w3-blue-grey">
                    <p><b>View / Edit Staff Profile</b></p>
                </div>

                <form class = "w3-container w3-padding" name="updateForm" action = "viewUpdateStaff.php" method = "post" onsubmit = "return confirmDialog2()" enctype = "multipart/form-data">
                    <p>
                    ...
                    <p>
                        ...
                        <select class = "w3-input w3-border w3-round" name = "depart" id = "iddepart">
                            <?php echo
                            "<option value = 'Sales'" . ($depart == 'Sales' ? 'selected' : '') .">Sales</option>
                            <option value = 'CS'" . ($depart == 'CS' ? 'selected' : '') .">Customer Service</option>
                            <option value = 'Intern'" . ($depart == 'Intern' ? 'selected' : '') .">Intern</option>";
                            ?>
                        </select>
                    </p>
                    ...
                    <p>
                        ...
                        <select class = "w3-input w3-border w3-round" name = "status" id = "idstatus">
                            <?php echo
