...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
            ...
            <a href="profile.php" class="w3-bar-item w3-button w3-hide-small w3-right" title="Profile"><i class="fa fa-user" style="font-size:20px"></i></a>
            <a href="record.php" class="w3-bar-item w3-button w3-hide-small w3-right" title="Attendance"><i class="fa fa-id-badge" style="font-size:20px"></i></a>
        ...
        <div id="idnavbar" class="w3-bar-block w3-blue-grey w3-hide w3-hide-large w3-hide-medium" >
            ...
            <a href="record.php" class="w3-bar-item w3-button w3-margin-right" title="Attendance"><i class="fa fa-id-badge" style="font-size:15px"></i>&nbsp; Attendance</a>
            <a href="profile.php" class="w3-bar-item w3-button w3-margin-right" title="Profile"><i class="fa fa-user" style="font-size:15px"></i>&nbsp; Profile</a>
